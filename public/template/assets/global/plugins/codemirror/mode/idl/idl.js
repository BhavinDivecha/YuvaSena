...
(function(mod) {
  ...
  var builtinArray = [
    'a_correlate', 'abs', 'acos', 'adahist_equal', 'alog',
    'alog2', 'alog10', 'amoeba', 'annotate', 'auser_dir',
    'auser_dir_query', 'arg_present', 'array_equal', 'array_indices',
    ...
    'profile', 'profiler', 'profiles', 'project_vol', 'show_fonts',
    ...
    'search3d', 'screate', 'sdelete', 'slock', 'srelease',
