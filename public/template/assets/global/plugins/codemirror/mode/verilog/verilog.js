...
CodeMirror.defineMode("verilog", function(config, parserConfig) {
   ...
   */
  var keywords = words(
    "acceon alias always always_comb always_ff always_latch and assert assign assume automatic before begin bind " +
    ...
    "specparam static string strong strong0 strong1 struct super supply0 supply1 sync_acceon sync_reject_on " +
