...
<head>
    ...
    <link rel="shortcut icon" href="/template/custom-assets/img/favicon.png" /> </head>
<!-- END HEAD -->
            ...
            <div class="col-md-5" style="border: 1px solid #bfbfbf; padding: 15px;background-color: white;">
                <center>
                    <a href="{{URL('/login"> 
                        ...
                        <h2><img src="/template/custom-assets/img/admin.png" height="350"></h2>
                        <h2>Admin Login</h2>
                    </a>    
                </center>        
            </div>
            <div class="col-md-5 pull-right" style="border: 1px solid #bfbfbf; padding: 15px;background-color: white;">
                <center>
                    <a href="{{URL('/test-login"> 
                        ...
                        <h2><img src="/template/custom-assets/img/exam.png" height="350"></h2>
                        <h2>Take Test</h2>
                    </a>    
                </center>        
            </div>
